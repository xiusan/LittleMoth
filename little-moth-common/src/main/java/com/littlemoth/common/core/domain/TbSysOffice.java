...
public class TbSysOffice extends BaseEntity {
     ...
     * 下级组织
     */
    private Set<String> offeceSon = new HashSet<String>();

    public Set<String> getOffeceSon() {
        return offeceSon;
    }

    public void setOffeceSon(Set<String> offeceSon) {
        this.offeceSon = offeceSon;
    }
