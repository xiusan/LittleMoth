...
public class TbSysUserController extends BaseController
{
    ...
    public TableDataInfo list(TbSysUserReq user)
    {
        ...
        return getDataTableTitle(ConvertVo.convertVoListTbSysUserVo(list),new PageInfo(list));
    }
    ...
    public ResultData getMyMessage()
    {
        TbSysUser tbSysUser = tbSysUserService.selectTbSysUserById(getUserId());
        return ResultData.success(ConvertVo.convertVoTbSysUserInfoVo(tbSysUser));
    }
    /**
     * 新增用户
     */
