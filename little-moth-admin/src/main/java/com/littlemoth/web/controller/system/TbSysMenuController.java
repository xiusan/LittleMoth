...
//        }
     ...
     */
    @GetMapping("/list")
    public TableDataInfo list(TbSysMenuReq menu) {
        startPage();
        List<TbSysMenu> list = tbSysMenuService.selectTbSysMenuList(menu.reqToBean());
        return getDataTableTitle(ConvertVo.convertVoListTbSysMenuVo(list),new PageInfo(list));
    }
     ...
     */
    @GetMapping("/listTree")
    public ResultData listTree(TbSysMenuReq menu) {
        List<TbSysMenu> list = tbSysMenuService.selectTbSysMenuList(menu.reqToBean());
    ...
    public ResultData treeselect(TbSysMenuReq menu) {
        List<TbSysMenu> menus = tbSysMenuService.selectTbSysMenuList(menu.reqToBean(), getLoginUser().getUser());
     ...
     */
    @PostMapping("/edit")
    public ResultData edit(@RequestBody TbSysMenuReq menu) {
        return ResultData.success(tbSysMenuService.updateTbSysMenu(menu.reqToBean()));
    }
